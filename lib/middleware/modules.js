...
module.exports = function(root, options) {
  ...
  var resolve = resolvers[options.resolve || 'amd'](options)
  ...
  return function modules(req, res, next) {
    ...
    switch (resolve.__algo) {
      case 'amd':
        // TODO: Implement test case for this, using `events` as a module.
        mid = utils.amdUnresolve(mid, options);
        break;
    }
