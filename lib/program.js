 ...
 * `Program` constructor.
 *
 * A program is a collection of modules.  A tree structure is used to traverse
 * the modules within a program, rooted at the main module.
 *
 * @param {Module} main
 * @api public
 */
...
/**
 * Transforms a program to AMD format.
 *
 * @param {Object} opts
